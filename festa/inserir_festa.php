...
$sql = "CALL Inserir_festa ('$txtidFesta', '$txtCliente_idCliente', '$txtaniversariante', '$txtidade', '$txtendereco', '$txttema','$txtcores','$txtdata_festa')";
