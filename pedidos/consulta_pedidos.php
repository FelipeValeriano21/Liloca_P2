...
<html lang="en">
  <head>
    ...
    <title>Pedidos cliente <?php echo $user_id ?>  </title>
  </head>
  <body style = "background-color: #DDBB73" >

 <header>
    <h1>LILOCA FESTAS - Pedidos do cliente <?php echo $user_id ?> </h1>
</header> 
...
<a href="../cliente/consulta_cliente.php"><button style="background-color:#483D8B; color: white">Voltar a consulta de clientes <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-closed-fill" viewBox="0 0 16 16">
